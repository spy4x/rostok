...
Generated 2026-07-03 from this report. 21 issues filed. 3 findings already resolved.
...
- OpenHands stack deleted
- mail-ai stack deleted

**Pre-existing issues (not re-filed):**
- #4: Migrate basic-auth to Authelia (overlaps with auth migration)
- #5: Rate limiting on Traefik
- #6: Network segmentation
- #7: Pin critical image digests (complementary to #52)
- #8: AdGuard DNS restriction
- #9: Second auth layer for Paperless/Stirling
- #10: Woodpecker docker.sock RW
